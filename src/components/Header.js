...
const Header = () => {
  return (
            ...
            <div className="row">
                <div className="col-6">
                    <p className="text-white mb-0">
                        Free Shipping over Rs100 & Free Returns
                        </p>
                </div>
                <div className="col-6">
                    <p className="text-end text-white">
                        Call: <a className='text-white' href="tel:+91 8935895675">+91 8935895675</a>
                        </p>
                </div>
            </div>
        </div>
    ...
    <header className="header-upper py-3">
        <div className="container-xxl">
            <div className="row align-items-center" >
                <div className="col-2">
                    <h2>
                        <Link className="text-white">Bazzar.com</Link></h2>
                </div>
                <div className="col-5">
    ...
    <header className="header-bottomn py-3">
        <div className="container-xxl">
            <div className="row">
